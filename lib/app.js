...
var MainComponent = React.createClass({
  ...
  getInitialState: function () {
    return {
      tools: [[{ id: 0, name: "aaa", description: "bbb", code: "toolcode1", upstream: [], downstream: [] }], [{ id: 1, name: "ccc", description: "ddd", code: "toolcode2", upstream: [], downstream: [] }, { id: 2, name: "eee", description: "fff", code: "toolcode3", upstream: [], downstream: [] }]],
      lastId: 2,
