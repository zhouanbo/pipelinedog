...
var CodeParse = {
  ...
  parseToolCommand: function (app) {
    //generate command for each tool
  ...
  convertOptionString: function (app, scope, segment) {
    //recognize LEASH expression and replace it, also update output_files info
    var tool = Util.filterByProperty(app.state.tools, "id", app.state.currentTool);
  ...
  parseLEASH: function (expression, tool, segment, fs, parseRange) {
